...
function processData(input) {
    ...
    var S = shortest_path(special_nodes, graph, special_nodes);
    for (var n in S){
        console.log(S[n].distance)
    }
}

function shortest_path(sources, graph, special_nodes) {
    // priority queue for unvisited nodes
    initialize_graph(graph, sources);
...
function initialize_graph(graph, sources) {
